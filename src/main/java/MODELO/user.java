...
public class user extends javax.swing.JFrame {
        ...
        btninicio.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (usuario.isEmpty() || contrasena.isEmpty()) {
                    ...
                    if (insertarUsuario(usuario, contrasena)) {
                        JOptionPane.showMessageDialog(null, "Usuario correctamente creado 😉😉 ....");
                    } else {
                        JOptionPane.showMessageDialog(null, "Error al crear el usuario. Puede que el usuario ya exista.");
                    }
                }
            }
        });
    ...
    private boolean insertarUsuario(String usuario, String contrasena) {
    ...
    private void initComponents() {
        ...
        setName("Registrar Usuario"); // NOI18N
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("F:\\CUARTO CICLO\\PROYECTO DELVELOPER\\ORACLE\\img\\usuario.jpg")); // NOI18N
